...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
		...
		switch (valor) {
			case "C":
				...
				break;
			case "=":
				if (!Objects.equals(numero1, "") && !Objects.equals(numero2, "")) {
					numero1 = operacion(operador);
					displayText.setText(numero1);
					operador = "=";
					numero2 = "";
				}
				break;
			...
			case "/":
				if (!Objects.equals(numero1, "") && !Objects.equals(numero2, "")) {
					...
					displayText.setText(numero1);
					numero2 = "";
				} else if (valor.equals("-") && ((operador == null && Objects.equals(numero1, "")) || (operador != null && Objects.equals(numero2, "")))){
					if (Objects.equals(operador, "=")){
						...
						numero2+= valor;
						displayText.setText(numero2);
					}else{
						numero1+= valor;
						displayText.setText(numero1);
					}
				}else if (!Objects.equals(numero1, "")) {
					operador = valor;
					displayText.setText("");
				}
				break;
	...
	public String operacion(String operador) {
		String respuesta = "";
		switch (operador) {
			case "+" -> respuesta = "" + (Integer.parseInt(numero1) + Integer.parseInt(numero2));
			case "-" -> respuesta = "" + (Integer.parseInt(numero1) - Integer.parseInt(numero2));
			case "*" -> respuesta = "" + (Integer.parseInt(numero1) * Integer.parseInt(numero2));
			case "/" -> respuesta = "" + (Integer.parseInt(numero1) / Integer.parseInt(numero2));
		}
